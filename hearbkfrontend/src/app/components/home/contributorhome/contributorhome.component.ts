...
@Component({
  selector: 'app-contributorhome',
  templateUrl: './contributorhome.component.html',
  styleUrls: ['./contributorhome.component.css']
})
export class ContributorhomeComponent implements OnInit {
